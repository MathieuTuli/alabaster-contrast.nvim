...
if vim.o.background == "dark" then
    ...
    theme = {
        ...
        --- LSP Semantic Tokens (to prevent overriding our theme)
        ["@lsp"] = { fg = ansi.white },
        ["@lsp.type.function"] = { fg = def_fg, bold = 1 },
        ["@lsp.type.variable"] = { fg = ansi.white },
        ["@lsp.type.parameter"] = { fg = ansi.white },
        ["@lsp.type.property"] = { fg = ansi.white },
        ["@lsp.type.namespace"] = { fg = ansi.white },
        ["@lsp.type.enum"] = { fg = ansi.white },
        ["@lsp.type.decorator"] = { fg = ansi.white },
        ["@lsp.type.class"] = { fg = ansi.white, bold = 1 },
        ["@lsp.type.builtinType"] = { fg = builtin_type, underline = 1 },
        ["@lsp.typemod.function.declaration"] = { fg = ansi.white, bold = 1 },
        ["@lsp.typemod.function.definition"] = { fg = ansi.white, bold = 1 },
        ["@lsp.typemod.class.declaration"] = { fg = ansi.white, bold = 1 },
        ["@lsp.typemod.class.definition"] = { fg = ansi.white, bold = 1 },
        ["@lsp.typemod.variable.declaration"] = { fg = ansi.white },
        ["@lsp.typemod.variable.definition"] = { fg = ansi.white },
        ["@lsp.typemod.parameter.declaration"] = { fg = ansi.white },
        ["@lsp.typemod.parameter.definition"] = { fg = ansi.white },
        ["@lsp.typemod.property.declaration"] = { fg = ansi.white },
        ["@lsp.typemod.property.definition"] = { fg = ansi.white },
        --- Gitsigns
        ...
        ["@markup.raw.markdown_inline"] = { fg = keyword, bold = true },
        ["@markup.raw.block.markdown"] = { fg = keyword, bold = true },
    ...
    theme = {
        ...
        ["@lsp"] = { fg = ansi.black },
        ["@lsp.type.function"] = { fg = def_fg, bold = 1 },
        ["@lsp.type.variable"] = { fg = ansi.black },
        ["@lsp.type.parameter"] = { fg = ansi.black },
        ["@lsp.type.property"] = { fg = ansi.black },
        ["@lsp.type.namespace"] = { fg = ansi.black },
        ["@lsp.type.enum"] = { fg = ansi.black },
        ["@lsp.type.decorator"] = { fg = ansi.black },
        ["@lsp.type.class"] = { fg = ansi.black, bold = 1 },
        ["@lsp.type.builtinType"] = { fg = builtin_type, underline = 1 },
        ["@lsp.typemod.function.declaration"] = { fg = ansi.black, bold = 1 },
        ["@lsp.typemod.function.definition"] = { fg = ansi.black, bold = 1 },
        ["@lsp.typemod.class.declaration"] = { fg = ansi.black, bold = 1 },
        ["@lsp.typemod.class.definition"] = { fg = ansi.black, bold = 1 },
        ["@lsp.typemod.variable.declaration"] = { fg = ansi.black },
        ["@lsp.typemod.variable.definition"] = { fg = ansi.black },
        ["@lsp.typemod.parameter.declaration"] = { fg = ansi.black },
        ["@lsp.typemod.parameter.definition"] = { fg = ansi.black },
        ["@lsp.typemod.property.declaration"] = { fg = ansi.black },
        ["@lsp.typemod.property.definition"] = { fg = ansi.black },
        --- Gitsigns
