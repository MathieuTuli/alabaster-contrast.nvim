...
if vim.o.background == "dark" then
    ...
    theme = {
        ...
        ["@lsp.typemod.function.declaration"] = { fg = def_fg, bold = 1 },
        ...
        ["@lsp.typemod.parameter.declaration"] = { fg = def_fg },
        ["@lsp.typemod.parameter.definition"] = { fg = def_fg },
        ["@lsp.typemod.property.declaration"] = { fg = def_fg },
        ["@lsp.typemod.property.definition"] = { fg = def_fg },
        --- Gitsigns
